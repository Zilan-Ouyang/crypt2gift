...
contract Crypt2Gift is ChainlinkClient{
    ...
    string constant  CRYPTO_COMPARE_JOBID = "9f0406209cf64acda32636018b33de11";
    ...
    event TokenTransfered(address indexed from, address indexed ercAddress, uint256 amount, uint date);
    function onTokenTransfer(address from, uint256 amount, bytes data) public{
        ...
        emit TokenTransfered(from, msg.sender, amount, deposits[from].date);
